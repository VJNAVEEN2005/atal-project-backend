...
const { registerUser, loginUser, getUser, updateUser, getProfileImage, deleteProfileImage, uploadProfileImage, uploadMiddleware, getAllUsers, updateAdminStatus } = require('../controllers/userController');
